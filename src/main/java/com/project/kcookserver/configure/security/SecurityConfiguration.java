    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
            ...
            .antMatchers(HttpMethod.GET, "/errors/**", "/app/cakes/**", "/app/additional-products/**", "/app/products/**", "/app/accounts/{accountId}/coupons", "/app/applicants", "/app/cities", "/app/locations/{cityIndex}", "/app/accounts/email/sms-token",
                "/app/popular-products", "/app/banner/static", "/app/banner/carousel", "/app/products/representative-cake", "/app/stores/representative", "/app/stores/area", "/app/cakes/on-sale", "/app/products/recently-updated","/app/popular-products" ).permitAll()
            ...
            .antMatchers(HttpMethod.POST, "/app/banner/**","/app/products/default-page-cake", "/app/stores/representative", "/app/products/representative-cake").hasRole("ADMIN")

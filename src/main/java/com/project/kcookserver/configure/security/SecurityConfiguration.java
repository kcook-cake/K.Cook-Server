...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(HttpMethod.GET, "/errors/**", "/app/cakes/**", "/app/additional-products/**", "/app/products/**","/app/accounts/{accountId}/coupons","/app/applicants", "/app/cities", "/app/locations/{cityIndex}","/app/accounts/email/sms-token").permitAll()
                ...
                .antMatchers(HttpMethod.PATCH, "/app/accounts/sms-token","/app/accounts/email/password").permitAll()
